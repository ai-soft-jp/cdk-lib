...
/**
 * Properties for RebootAlarm
 */
export interface RebootAlarmProps {
    /**
     * The EC2 instance
     */
 ...
 */
export declare class RebootAlarm extends cloudwatch.Alarm {
    constructor(scope: Construct, id: string, props: RebootAlarmProps);
}
